        ...
        <div className="flex flex-col justify-center w-full p-8 pt-0 lg:w-1/2 lg:px-12 xl:px-24 ">
          <form onSubmit={onSubmit}>
            ...
            <button
              ...
              className="w-full focus:outline-none text-lg text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
            >
              📩 Get in touch
            </button>
          </form>
