        ...
        <div className="mx-auto max-w-[1340px] px-4 py-16 sm:px-6 sm:py-24 lg:me-0 lg:pe-0 lg:ps-8">
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:items-center lg:gap-x-16">
            <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
              ...
              <p className="mt-4 text-gray-500">
                Participants&apos; glowing insights show their immense happiness
                ...
                <div className="swiper-wrapper ">
                    ...
                    <blockquote className="flex flex-col justify-between h-full p-12 bg-white ">
                      <div>
                        ...
                        <div className="mt-4">
                          ...
                          <p className="mt-4 leading-relaxed text-gray-500">
                            The atmosphere was family like despite the fact that
                            it was my first yoga class. I was more immobile than
                            I thought and didn&apos;t do everything right the
                            first time, but Jesse helped me a lot with his clear
                            instructions. <br />
                            <span className="font-bold">
                              {" "}
                              After the class I felt much more relaxed, always
                              happy to come back.
                            </span>
                          </p>
                        </div>
                  ...
                  <div className="swiper-slide">
                    <blockquote className="flex flex-col justify-between h-full p-12 bg-white">
                      ...
                      <footer className={nameStyle}>
                        &mdash; ClassPass User
                      </footer>
                      <div className="flex flex-col">
                        <div>
                          <span className="bg-yellow-100 text-yellow-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">
          ...
          <div className="flex justify-center gap-4 mt-8 lg:hidden">
            <button
              ...
              className="p-4 text-purple-600 border border-purple-600 rounded-full prev-button hover:bg-purple-600 hover:text-white"
            >
              <svg
            ...
            <button
              ...
              className="p-4 text-purple-600 border border-purple-600 rounded-full next-button hover:bg-purple-600 hover:text-white"
            >
              <svg
                className="w-5 h-5"
                fill="none"
