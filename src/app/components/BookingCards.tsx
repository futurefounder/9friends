      ...
      >
        ...
        <div className="mt-4">
          <p className="max-w-[40ch] text-sm text-gray-500">
            ...
            {/* </div> */}
            Get ready for an energizing and joyful experience! ✨ Each 1. & 3.
            Wed. - Yoga Drills: Strengthening exercises for learning / mastering
            advanced yoga poses (Beginners welcome!) Each 2. & 4. Wed. - Chakra
            Flow: A practice focused on balancing and activating the body&apos;s
