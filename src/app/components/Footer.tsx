...
const Footer = () => {
  ...
  return (
            ...
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-500">
                  Join our Community and Receive Soulful Insights on Yoga,
                  Philosophy, and the Newest Developments Around 9Friends.
                </p>
              </div>
            </div>
              ...
              <form onSubmit={onSubmit} className="w-full">
                ...
                <div className="p-2 border border-gray-100 focus-within:ring sm:flex sm:items-center sm:gap-4">
                  <input
                    ...
                    className={`${
                      disableFields
                        ? "bg-gray-300 w-full border-none focus:border-transparent focus:ring-transparent sm:text-sm"
                        : "w-full border-none focus:border-transparent focus:ring-transparent sm:text-sm"
                    } ${disableFields}`}
                    disabled={submitted}
                  />
                  ...
                  <button
                    ...
                    type="submit"
                    className="w-full px-6 py-3 mt-1 text-sm font-bold tracking-wide text-white uppercase transition-none bg-gray-800 rounded-lg hover:bg-fuchsia-700 sm:mt-0 sm:w-auto sm:shrink-0"
                  >
                    {submitted ? "🎉 Thank You" : "💌 Connect Now"}
                  </button>
                </div>
              </form>
            </div>
        ...
        <div className="pt-8 mt-8 border-t border-gray-100">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-gray-500">
              &copy; 2023. /9Friends. All rights reserved.
            </p>
    ...
    //   <div classNameName="w-full max-w-screen-xl p-4 py-6 mx-auto lg:py-8">
    ...
    //         © 2023 <span classNameName="font-bold text-purple-300">/</span>
    //         9FRIENDS by&nbsp;
    //         <a
    //           href="https://jessekhala.com/"
    //           classNameName="underline hover:text-purple-600"
    //         >
    //           Jesse Khala
    //         </a>
    //         . All Rights Reserved.
