    ...
    <div>
      ...
      <div className="flex justify-center">
        <div className="max-w-2xl px-4 py-8">
          <br /> <h1 className="mb-4 text-2xl font-bold">Privacy Policy</h1>
          <p className="mb-4">Last updated: June 04, 2023</p>
          <p className="mb-4">
          ...
          <h2 className="mb-2 text-xl font-bold">Interpretation</h2>
          <p className="mb-4">
          ...
          <h2 className="mb-2 text-xl font-bold">Definitions</h2>
          ...
          <ul className="mb-4 list-disc list-inside">
            ...
            <li>
              ...
              in this Agreement) refers to my9Friends.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to my9Friends, accessible from
              https://www.my9friends.com
            </li>
            <li>
          ...
          <br /> <h3 className="mb-4 text-xl font-bold">Personal Data</h3>
          <p className="mb-4">
          ...
          <br /> <h3 className="mb-4 text-xl font-bold">Usage Data</h3>
          <p className="mb-4">
          ...
          <br />{" "}
          <h3 className="mb-4 text-xl font-bold">Business Transactions</h3>
          <p className="mb-4">
          ...
          <br /> <h3 className="mb-4 text-xl font-bold">Law enforcement</h3>
          <p className="mb-4">
          ...
          <br />{" "}
          <h3 className="mb-4 text-xl font-bold">Other legal requirements</h3>
          <p className="mb-4">
          ...
          <br />{" "}
          <h1 className="mb-4 text-2xl font-bold">Children&aposs Privacy</h1>
          <p className="mb-4">
          ...
          <br /> <h1 className="mb-4 text-2xl font-bold">Contact Us</h1>
          <p className="mb-4">
            If you have any questions about this Privacy Policy, You can contact
            us:
          </p>
          <ul className="mb-4 list-disc list-inside">
            <li>By email: hello@my9friends.com</li>
          </ul>
        </div>
      </div>
      <Footer />
